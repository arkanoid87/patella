...
def AddEndianness(builder, endianness):
    return SchemaAddEndianness(builder, endianness)
...
def AddFields(builder, fields):
    return SchemaAddFields(builder, fields)
...
def AddCustomMetadata(builder, customMetadata):
    return SchemaAddCustomMetadata(builder, customMetadata)
...
def AddFeatures(builder, features):
    return SchemaAddFeatures(builder, features)
