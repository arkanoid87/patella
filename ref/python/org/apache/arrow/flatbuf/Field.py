...
def AddDictionary(builder, dictionary):
    return FieldAddDictionary(builder, dictionary)
...
def AddChildren(builder, children):
    return FieldAddChildren(builder, children)
...
def AddCustomMetadata(builder, customMetadata):
    return FieldAddCustomMetadata(builder, customMetadata)
